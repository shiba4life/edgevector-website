...
export default function About() {
  return (
    <>
      ...
      <p>We believe that people, not corporations or centralized platforms, should determine how their data is stored, accessed, and used. We build the open ecosystem that makes this possible: <span className="bold white">secure, user-controlled computation on personal data</span>.</p>

      <Section variant="sage">
        <h2><span className="bold">MISSION</span></h2>

        <p>To ensure that every person controls their own data: how it is stored, who can access it, and how it is used. We build open-source infrastructure for seamless data ingestion, practical data use, security by default, verifiable trustworthiness, and long-term personal data resilience.</p>
      </Section>
      ...
      <Section variant="slate">
        ...
        <ul className="principle-list">
          <li><span className="bold white">User control is non-negotiable.</span> People decide what data to store, who can access it, and for how long. Real revocation, not permission theater.</li>
          <li><span className="bold white">Security by default.</span> End-to-end encryption, granular permissions, and economic safeguards protect data without requiring user expertise.</li>
          <li><span className="bold white">Verifiable, not trusted.</span> Signed writes, transparent access logs, and data provenance provide cryptographic guarantees about authenticity and integrity.</li>
          <li><span className="bold white">Practical ownership.</span> Data control is meaningful only when people can use their data: through personal assistants, selective disclosure, and permissioned APIs.</li>
          <li><span className="bold white">Built for decades.</span> Personal data infrastructure must be resilient, with secure cloud backups and accessible permission management for non-technical users.</li>
          <li><span className="bold white">Open by default.</span> Every tool, protocol, and schema is open source. No proprietary lock-in. No closed ecosystems.</li>
        </ul>
      </Section>
      ...
      <Section variant="lavender">
        ...
        <p>Imagine choosing to let anonymized insights from your data contribute to medical research, without any researcher seeing your records. Or allowing specific queries against your expertise and receiving compensation when matches are found. Or sharing travel recommendations with friends without exposing your trip details.</p>

        <p>This is the vision: <span className="bold white">individual control with collective benefit</span>. Personal data infrastructure that serves people, not platforms.</p>
      </Section>

      <Section variant="rose">
        <h2><span className="bold">GET INVOLVED</span></h2>

        <p>Edge Vector Foundation is an open community. Whether you&rsquo;re a developer, researcher, privacy advocate, or someone who believes in a better model for personal data, there&rsquo;s a place for you.</p>

        <p>
          <a href="https://github.com/shiba4life/fold_db" target="_blank" rel="noreferrer" className="link-btn">[Contribute on GitHub]</a>{'  '}
          <a href="https://exemem.com" target="_blank" rel="noreferrer" className="link-btn">[Exemem]</a>{'  '}
